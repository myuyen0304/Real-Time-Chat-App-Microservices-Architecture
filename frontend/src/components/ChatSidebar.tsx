...
const ChatSidebar = ({
  ...
  return (
    <aside
      ...
      } sm:translate-x-0 fixed sm:static inset-y-0 left-0 z-20 w-full sm:w-80 bg-gray-800 border-r border-gray-700 flex flex-col transition-transform duration-300 ease-in-out max-w-sm`}
    >
      {/* {header} */}
                    ...
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        ...
                        onlineUsers.includes(u._id) && (
                          <span 
                          className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full bg-green-500 border-2 border-gray-900">
      ...
      <div className="p-4 border border-gray-700 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 pỷ
        rounded-lg hover:bg-red-600 transition-colors text-red-500 hover:text-white"
        >
